...
Marks a task as complete via TaskService.
"""
...
from ..schemas import CompleteTaskInput


async def complete_task(user_id: UUID, task_id: UUID, db: AsyncSession) -> dict:
    """
    ...
    Returns:
        dict: Updated task object with is_completed=True and completed_at timestamp
    ...
    try:
        ...
        # Mark task complete (TaskService handles authorization)
